 ...
 *  @review 
 * 
 * 	The mx.filters.GradientBevelFilter class is based on 
 *  flash.filters.GradientBevelFilter but adds support for dynamically updating 
 *  property values. 
 *  When a property changes, it dispatches an event that tells the filter owner to
 *  reapply the filter. Use this class instead of flash.filters.GradientBevelFilter if you plan
 *  to dynamically change the filter property values.  
 * 
 *  @see flash.filters.GradientBevelFilter
 */	
public class GradientBevelFilter extends EventDispatcher implements IFlexBitmapFilter
{
	...
	/**
	 * @copy flash.filters.GradientBevelFilter
	 */ 	
	...
	/**
	 *  Creates a flash.filters.GradientBevelFilter instance using the current 
	 *  property values. 
	 * 
	 *  @return flash.filters.GradientBevelFilter instance
	 */		
