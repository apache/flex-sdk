...
public class BitmapGraphic extends GraphicElement
{
     ...
     * 
     *  When set to <code>BitmapResizeMode.NORMAL</code>, the bitmap will
     *  end at the edge of the region.
     * 
     *  When set to <code>BitmapResizeMode.REPEAT</code>, the bitmap will
     *  be repeated to fill the region.
     *
     *  When set to <code>BitmapResizeMode.SCALE</code>, the bitmap will
     *  stretch to fill the region.
     * 
