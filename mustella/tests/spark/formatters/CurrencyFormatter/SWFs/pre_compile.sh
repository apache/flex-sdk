...
$SDK_DIR/bin/mxmlc  -static-rsls=true CF_FlexModule.mxml

$SDK_DIR/bin/mxmlc  -static-rsls=true CF_StyleModule.mxml


echo "Compiling external CSS SWFs..."

$SDK_DIR/bin/mxmlc  -static-rsls=true CF_extStyle.css
