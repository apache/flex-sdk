...
$SDK_DIR/bin/mxmlc  -static-rsls=true assets/CustomSparkButtonBarModule.mxml -sp ./

$SDK_DIR/bin/mxmlc  -static-rsls=true assets/newClasses/SF_StyleModule.mxml -sp ./
