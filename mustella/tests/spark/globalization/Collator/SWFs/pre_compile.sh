...
$SDK_DIR/bin/mxmlc  -static-rsls=true CLT_FlexModule.mxml
$SDK_DIR/bin/mxmlc  -static-rsls=true CLT_StyleModule.mxml


echo "Compiling external CSS SWFs..."

$SDK_DIR/bin/mxmlc  -static-rsls=true myExtStyle.css
$SDK_DIR/bin/mxmlc  -static-rsls=true myExtType.css
