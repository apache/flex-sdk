...
package comps
{
    ...
    public class SolidTabbedViewNavigatorTabBarSkin extends TabbedViewNavigatorTabBarSkin
    {
        /**
        * Use a custom Button skin class that is solid and less prone to unnecessary bitmap breakages 
        */
        override protected function createChildren():void
        {
            ...
            firstButton.skinClass = comps.SolidButtonSkin;

            lastButton = new ButtonBarButtonClassFactory(ButtonBarButton);
            lastButton.skinClass = comps.SolidButtonSkin;

            middleButton = new ButtonBarButtonClassFactory(ButtonBarButton);
            middleButton.skinClass = comps.SolidButtonSkin;
