...
package comps
{
	...
	/**
	 * An extremely simple subclass of IconItemRenderer designed so Mustella tests
	 * can key off of specific events.
	 * 
	 * This uses a custom iconDisplayClass that fires an event on the List when the icon of a 
