...
package skins
{
    ...
    import spark.skins.mobile240.assets.*;
    
    public class iOSDateSpinnerSkin extends SpinnerListContainerSkin
    {
        public function iOSDateSpinnerSkin()
        {
            borderClass = spark.skins.mobile240.assets.SpinnerListContainerBackground;
            selectionIndicatorClass = skins.iOSSelectionIndicator;
