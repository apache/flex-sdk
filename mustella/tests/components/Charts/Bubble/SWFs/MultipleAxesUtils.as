...
package
{
	...
	{ 	
		...
		public static function AxisRenderers(testCaseType:String, chart:Object):void
		{
			...
			var closeBubble:BubbleSeries = new BubbleSeries();
			...
			{	
				case "noAxisSpecified":	
					...
					closeBubble.radiusField = "low";
					closeBubble.yField = "close";
					closeBubble.xField = "month";						
					seriesArray.push(closeBubble);
				...
				case "axisRendererWithPlacement":
					...
					closeBubble.yField = "close";	
					closeBubble.radiusField = "low";
					closeBubble.horizontalAxis = myHorH1;			
					seriesArray.push(closeBubble);
		...
		public static function axisTest(testCaseType:String, chart:Object):void
		{
			...
			{	
				...
				case "diffAxisType":
					...
					closeBubble.yField = "close";
					closeBubble.xField = "date";
					closeBubble.radiusField = "low";
					closeBubble.horizontalAxis = myHorH11;			
					seriesArray.push(closeBubble);
