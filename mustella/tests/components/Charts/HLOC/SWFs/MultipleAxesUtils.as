...
package
{
	...
	{ 	
		...
		public static function AxisRenderers(testCaseType:String, chart:Object):void
		{
			...
			var closeHLOC:HLOCSeries = new HLOCSeries();
			...
			{	
				case "noAxisSpecified":	
					...
					closeHLOC.closeField = "close";
					closeHLOC.openField = "open";
					closeHLOC.highField = "high";
					closeHLOC.lowField = "low";
					closeHLOC.xField = "month";						
					seriesArray.push(closeHLOC);
				...
				case "axisRendererWithPlacement":
					...
					closeHLOC.highField = "high";
					closeHLOC.lowField = "low";								
					closeHLOC.horizontalAxis = myHorH1;			
					seriesArray.push(closeHLOC);
		...
		public static function axisTest(testCaseType:String, chart:Object):void
		{
			...
			{	
				...
				case "diffAxisType":
					...
					closeHLOC.highField = "high";
					closeHLOC.lowField = "low";
					closeHLOC.xField = "date";
					closeHLOC.horizontalAxis = myHorH11;			
					seriesArray.push(closeHLOC);
