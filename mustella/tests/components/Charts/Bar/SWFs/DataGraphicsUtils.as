	...
	{ 
		...
		public static function DrawShapes(testCaseType:String, chart:Object, elementType:String):void
		{
			...
			{	
				...
				// draw line
				myCanvas.clear();
				myCanvas.moveTo(200, "0");
				myCanvas.beginFill(0xFFCC04, 1);
				myCanvas.lineStyle(1, 0x003399, 1.0);
				myCanvas.lineTo(30, "5"); 			
				break;
				...
				myCanvas.clear();
				myCanvas.beginFill(0xFFCC04, 1);
				myCanvas.drawRect(20,"2",10, "5");
				var myLabel:Label = new Label();
				myLabel.text = "Test";
				myCanvas.addChild(myLabel);
				myCanvas.updateDataChild(myLabel, 40, "3");
				myCanvas.endFill();			
				break;
				...
				myCanvas.drawRoundedRect(20,"4", 10,"5",15);
				myCanvas.endFill();        		
				break;
				...
				myCanvas.drawEllipse(20,"1",30, "4");
				myCanvas.endFill();			
				break;
		...
		public static function DrawShapesWithNegativeVal(testCaseType:String, chart:Object, elementType:String):void
		{
			...
			{	
				...
				myCanvas.clear();
				myCanvas.beginFill(0x003399, 1);
				myCanvas.drawRoundedRect( 20,"5",10, "6",15);
				myCanvas.endFill();
				chart.annotationElements = chart.annotationElements.concat(myCanvas);
				break;
		...
		public static function DrawWithCartesianCanvasValue(testCaseType:String, chart:Object, elementType:String):void
		{
			...
			{	
				...
				myCanvas.clear();
				myCanvas.beginFill(0xFFCC04, 1);
				myCanvas.drawCircle(20, new CartesianCanvasValue("2"), 50);
				myCanvas.endFill();			
				break;
				...
				myCanvas.beginFill(0xFFCC04, 1);
				myCanvas.lineStyle(1, 0x003399, 1.0);
				myCanvas.lineTo( 30, new CartesianCanvasValue("5", 30)); 			
				break;
				...
				myCanvas.clear();
				myCanvas.beginFill(0xFFCC04, 1);
				myCanvas.drawRect(20,new CartesianCanvasValue("2",5), 10, new CartesianCanvasValue("5",5));
				var myLabel:Label = new Label();
				myLabel.text = "Test";
				myCanvas.addChild(myLabel);
				myCanvas.updateDataChild(myLabel, 40, "3");
				...
				myCanvas.clear();
				myCanvas.beginFill(0x003399, 1);
				myCanvas.drawRoundedRect(20, new CartesianCanvasValue("3"), 10, new CartesianCanvasValue("5"),15);
				myCanvas.endFill();			
				break;
				...
				myCanvas.clear();
				myCanvas.beginFill(0xFDCC34, 1);
				myCanvas.drawEllipse(new CartesianCanvasValue(20,-10),new CartesianCanvasValue("1",10), new CartesianCanvasValue(30, 10), new CartesianCanvasValue("4",10));
				myCanvas.endFill();			
				break;
				...
				myCanvas.clear();
				myCanvas.beginFill(0xFFCC04, 1);
				myCanvas.curveTo(25, new CartesianCanvasValue("0", 10), 30, new CartesianCanvasValue("5"));
				myCanvas.endFill();			
				break;
			}
			switch(elementType)
		...
		public static function AddCompWithUpdateDataChild(testCaseType:String, chart:Object, elementType:String):void
		{
			...
			{	
				...
				myLabel.text = "Test";
				myCanvas.addChild(myLabel);
				myCanvas.updateDataChild(myLabel, 20,"2", 30,  "4", 3, 4);			
				break;
				...
				myLabel.text = "Test";
				myCanvas.addChild(myLabel);
				myCanvas.updateDataChild(myLabel,40, "3", 20,  "5", 1, 2);
				break;			
				...
				myLabel.text = "Test";
				myCanvas.addChild(myLabel);
				myCanvas.updateDataChild(myLabel, 40,"3", 30, "2",  0, 0);
				break;
