...
public class RadialGradientFillNode extends AbstractFillNode implements ScalableGradientNode
{
     ...
     * bounding box. A value of 1 lies against the right edge of the box; 
     * a value of -1 lies against the left edge. The default value of 0 places 
     * it in the middle of the box. */
    ...
    public void addChild(FXGNode child)
    {
        ...
        else if (child instanceof GradientEntryNode)
        {
            ...
            else if (entries.size() >= GRADIENT_ENTRIES_MAX_INCLUSIVE)
            {
                ...
                FXGLog.getLogger().log(FXGLogger.WARN, "InvalidRadialGradientNumElements", null, getDocumentName(), startLine, startColumn);
                return;
            }
    ...
    /**
     * Set radial gradient fill properties. Delegates to the parent class
     ...
     * bounding box. A value of 1 lies against the right edge of the box; 
     * a value of -1 lies against the left edge. The default value of 0 places 
     * it in the middle of the box. </li>
     * </ul>
     * </p>
     * 
