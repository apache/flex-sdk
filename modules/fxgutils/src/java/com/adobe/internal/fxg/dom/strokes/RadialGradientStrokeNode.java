...
public class RadialGradientStrokeNode extends AbstractStrokeNode implements ScalableGradientNode
{
    ...
    /** The placement of the focal point of the radial gradient along the 
     * horizontal center axis of the gradient bounding box. 
     * A value of 1 lies against the right edge of the box; a value of -1 
     * lies against the left edge. The default value of 0 places it in the 
     * middle of the box.*/
    ...
    public void addChild(FXGNode child)
    {
        ...
        else if (child instanceof GradientEntryNode)
        {
            ...
            else if (entries.size() >= GRADIENT_ENTRIES_MAX_INCLUSIVE)
            {
                ...
                FXGLog.getLogger().log(FXGLogger.WARN, "InvalidRadialGradientStrokeNumElements", null, getDocumentName(), startLine, startColumn);
                return;
            }
     ...
     * <ul>
     * <li><b>x</b> (Number): The horizontal translation of the gradient transform 
     * that defines the horizontal center of the gradient.</li>
     * <li><b>y</b> (Number): The horizontal translation of the gradient transform 
     * that defines the horizontal center of the gradient.</li>
     * <li><b>rotation</b> (Number): The rotation of the gradient transform.</li>
     * <li><b>scaleX</b> (Number): The horizontal scale of the gradient transform 
     ...
     * <li><b>focalPointRatio</b> (Number): The placement of the focal point 
     * of the radial gradient along the horizontal center axis of the gradient 
     * bounding box. Valid range from -1 to 1. A value of 1 lies against the 
     * right edge of the box; a value of -1 lies against the left edge. The 
     * default value of 0 places it in the middle of the box.</li>
     * </ul>
     * </p>
     *  
     * @param name the name
