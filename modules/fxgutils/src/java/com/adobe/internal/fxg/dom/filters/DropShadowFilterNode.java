...
public class DropShadowFilterNode extends AbstractFilterNode
{
    ...
    /** The color of the glow. Default to black. */
    ...
    /** 
     * Set drop shadow filter properties. Delegates to the parent class
     ...
     * <li><b>hideObject</b> (Boolean): If true, the original content is not 
     * copied into the final output. </li>
