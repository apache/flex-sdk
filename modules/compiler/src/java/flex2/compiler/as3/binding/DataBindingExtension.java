...
public final class DataBindingExtension implements Extension
{
    ...
    private static final String ARRAY_ELEMENT_WATCHER = "ArrayElementWatcher";
    private static final String ARRAY_WATCHER = "arrayWatcher";
    private static final String BINDINGS = "bindings";
    private static final String EXCLUDE_CLASS = "ExcludeClass";
    private static final String FBS = "fbs";
    private static final String FUNCTION = "Function";
    private static final String FUNCTION_RETURN_WATCHER = "FunctionReturnWatcher";
    ...
    private static final String PARENT_WATCHER = "parentWatcher";
    private static final String PROPERTY_GETTER = "propertyGetter";
    private static final String PROPERTY_WATCHER = "PropertyWatcher";
    private static final String REPEATER_COMPONENT_WATCHER = "RepeaterComponentWatcher";
    private static final String REPEATER_ITEM_WATCHER = "RepeaterItemWatcher";
    private static final String SETUP = "setup";
    private static final String STATIC_PROPERTY_GETTER = "staticPropertyGetter";
    private static final String STATIC_PROPERTY_WATCHER = "StaticPropertyWatcher";
    private static final String TARGET = "target";
    private static final String UPDATE_PARENT = "updateParent";
    private static final String WATCHERS = "watchers";
    private static final String WATCHER_SETUP_UTIL = "watcherSetupUtil";
    private static final String XML_WATCHER = "XMLWatcher";
