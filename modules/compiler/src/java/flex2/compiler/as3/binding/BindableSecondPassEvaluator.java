...
public class BindableSecondPassEvaluator extends GenerativeSecondPassEvaluator
{
    ...
    private static final String CREATE_UPDATE_EVENT = "createUpdateEvent";
    ...
    private static final String EVENT_DISPATCHER_VAR = "eventDispatcher";
    private static final String EVENT_DISPATCHER_CLASS = "EventDispatcher";
    private static final String FLASH_EVENTS = "flash.events";
    private static final String FUNCTION = "Function";
    private static final String HAS_EVENT_LISTENER = "hasEventListener";
    private static final String INT = "int";
    private static final String I_EVENT_DISPATCHER = "IEventDispatcher";
    private static final String LISTENER = "listener";
    private static final String MX_EVENTS = "mx.events";
    private static final String OBJECT = "Object";
    private static final String OLD_VALUE= "oldValue";
    private static final String PRIORITY = "priority";
    private static final String PROPERTY_CHANGE = "propertyChange";
    private static final String PROPERTY_CHANGE_EVENT = "PropertyChangeEvent";
    private static final String REMOVE_EVENT_LISTENER = "removeEventListener";
    private static final String STRING = "String";
    private static final String TYPE = "type";
    private static final String USE_CAPTURE = "useCapture";
    private static final String VALUE = "value";
    private static final String WEAK_REF = "weakRef";
    private static final String WILL_TRIGGER = "willTrigger";
    private static final String _BINDING_EVENT_DISPATCHER = "_bindingEventDispatcher";
    private static final String _STATIC_BINDING_EVENT_DISPATCHER = "_staticBindingEventDispatcher";
