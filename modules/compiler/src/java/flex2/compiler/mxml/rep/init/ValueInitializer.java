...
public abstract class ValueInitializer implements Initializer, Cloneable
{
    ...
    private static final String ADD_LAYER = "addLayer";
    private static final String BINDING_MANAGER = "BindingManager";
    private static final String CD = "cd";
    private static final String CHILD_DESCRIPTORS = "childDescriptors";
    private static final String CLASS = "Class";
    private static final String CREATE_XML_DOCUMENT = "createXMLDocument";
    private static final String DEFERRED_INSTANCE_FROM_CLASS = "DeferredInstanceFromClass";
    private static final String DEFERRED_INSTANCE_FROM_FUNCTION = "DeferredInstanceFromFunction";
    private static final String DESIGN_LAYER = "designLayer";
    private static final String DISPATCH_EVENT = "dispatchEvent";
    private static final String DOCUMENT = "document";
    private static final String EXECUTE_BINDINGS = "executeBindings";
    ...
    private static final String XML_UTIL = "XMLUtil";
    private static final String _DOCUMENT_DESCRIPTOR = "_documentDescriptor";
    private static final String __CLASS = "__class";
    private static final String __E = "__e";
