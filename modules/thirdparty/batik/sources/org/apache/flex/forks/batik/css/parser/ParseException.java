...
/**
 *  Modified by Adobe Flex.  Added params, ParseException with params arg and getParams().
 */
...
public class ParseException extends RuntimeException {
     ...
     * Creates a new ParseException.
     * @param message The error or warning message.
     * @param params The message args.
     * @param line The line of the last parsed character.
     * @param column The column of the last parsed character.
     */
    public ParseException (String message, Object[] params, int line, int column) {
	super(message);
	exception = null;
	this.params = params;
	lineNumber = line;
