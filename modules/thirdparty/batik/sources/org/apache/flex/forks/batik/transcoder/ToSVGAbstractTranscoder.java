 ...
 *  {@link org.apache.flex.forks.batik.svggen.SVGGraphics2D} with this Document</li>
 *  <pre>
 *    Document doc = this.createDocument(output);
 *    svgGenerator = new SVGGraphics2D(doc);
 *  </pre>
 *  <li>Perform the effective transcoding, using the
 *  {@link org.apache.flex.forks.batik.svggen.SVGGraphics2D} previously created</li>
 *  <li>then call the
...
public abstract class ToSVGAbstractTranscoder extends AbstractTranscoder
    ...
    /** Get the {@link org.apache.flex.forks.batik.svggen.SVGGraphics2D} associated
