 ...
 */
public class SAXParserMMImpl extends javax.xml.parsers.SAXParser
     ...
     */
    SAXParserMMImpl(SAXParserFactoryMMImpl spf, Hashtable features) 
        throws SAXException {
     ...
     * @param features Hashtable of SAX features, may be null
     */
    SAXParserMMImpl(SAXParserFactoryMMImpl spf, Hashtable features, boolean secureProcessing)
        throws SAXException
    {
     ...
     * its initial state.
     */
    public static class JAXPSAXParser extends org.apache.xerces.parsers.SAXParserMMImpl {
        
        private HashMap fInitFeatures = new HashMap();
        private HashMap fInitProperties = new HashMap();
        private SAXParserMMImpl fSAXParser;

        public JAXPSAXParser() {
            super();
        }
        
        JAXPSAXParser(SAXParserMMImpl saxParser) {
            super();
