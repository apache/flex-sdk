...
//modified by rsun 11/06/03 - import XMLAttributesMMImpl
//instead of XMLAttributesImpl
 ...
 */
public abstract class AbstractSAXParserMMImpl
              ...
              Parser, XMLReader // SAX1, SAX2
{
    ...
    /** Default constructor. */
    protected AbstractSAXParserMMImpl(XMLParserConfiguration config) {
        super(config);
    ...
    public static final class AttributesProxy
        ...
        // modified by rsun 11/06/03 - added function
        public int getLineNumber(int index) {
            if(!(fAttributes instanceof XMLAttributesMMImpl)) {
                return -1;
            }
            return ((XMLAttributesMMImpl)fAttributes).getLineNumber(index);
        }
