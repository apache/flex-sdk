 ...
 */
//modified by rsun 11/06/03 - subclass XMLDocumentScannerMMImpl instead of XMLDocumentScannerImpl
    ...
    throws IOException, XNIException {
        ...
        if (fBindNamespaces) {
            ...
            if (attributes instanceof XMLAttributesMMImpl) { 
                ((XMLAttributesMMImpl)attributes).setLineNumber(attrIndex, fEntityScanner.getLineNumber());
            }
        }
        else {
...
} // class XMLNSDocumentScannerMMImpl
