...
public class PopUpUtil
{
     ...
     */
    public static function applyPopUpTransform(owner:DisplayObjectContainer, systemManager:ISystemManager,
                                               popUp:IFlexDisplayObject, popUpPoint:Point):void
    {
        ...
        if (ownerComponent)
        {
            ...
            var tmpColorTransform:ColorTransform = ownerComponent.$transform.concatenatedColorTransform;
