...
public class HGroup extends Group
{
     ...
     *  of the group plus any <code>paddingTop</code>.
     *
     *  The base line is the virtual horizontal line to which child elements's text is aligned.
     *
    ...
    {
        return horizontalLayout.actualAlignmentBaseline;
    }
     ...
     *  it is relative to the top edge of the group plus any <code>paddingTop</code>.
     *
     *  The base line can be specified as either an explicit number, or as a numberical offset to
     *  the computed maximum of the childrens' text ascent by using the "maxAscent:offset" syntax.
     *
    ...
    {
        return horizontalLayout.alignmentBaseline;
    }
    ...
    {
        horizontalLayout.alignmentBaseline = value;
    }
