...
/**
 *  Represents event objects that are dispatched when bounds of a
 *  TitleWindow changes either by moving or resizing.
 *
...
public class TitleWindowBoundsEvent extends Event
{
	 ...
	 * 		this event is cancelable, beforeBounds is the current bounds of
	 ...
	 * 		this event is cancelable, afterBounds is the future bounds of
	 ...
	 *  is cancelable, beforeBounds is the current bounds of
	 *  the window. Otherwise, it is the bounds before a change occurred.
	 *  
     *  @langversion 3.0
     *  @playerversion Flash 10
	 ...
	 *  is cancelable, afterBounds is the future bounds of
	 *  the window. Otherwise, it is the current bounds.
	 *  
     *  @langversion 3.0
     *  @playerversion Flash 10
